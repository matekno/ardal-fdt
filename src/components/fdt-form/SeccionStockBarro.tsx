  ...
  return (
    <SectionCard title="Stock de Barro">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <FormField name="stockBarro.arena" label="Arena" type="number" unit="MT" required />
        <FormField name="stockBarro.recupero" label="Recupero" type="number" unit="MT" required />
      </div>
